...
#
# Default image size is 1.6 GiB, sized to fit inside stock C60 system_a
# (1.75 GiB per PROBE_NOTES.md) with ~150 MiB headroom for ext4 metadata.
# Anything bigger gets refused when dd'd into /dev/disk/by-partlabel/system_a.
#
# USAGE
...
ROOTFS=""
OUT=""
# 1.6 GiB. stock system_a = 1.75 GiB = 1879048192 B. We pick 1.6 GiB
# = 1717986918 B (rounded down to a power of 2 MiB = 1.5 GiB exactly =
# 1610612736). 1.6 GiB headroom-safe but big enough for a Debian rootfs
# with our package set (TC8 typical is ~900 MiB used).
